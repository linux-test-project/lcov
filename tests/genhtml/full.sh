#!/usr/bin/env bash
#
# Create HTML output for info files containing 100% coverage rates
#
...
OUTDIR="out_full"
STDOUT="full_stdout.log"
STDERR="full_stderr.log"

rm -rf "${OUTDIR}"

# Run genhtml
$COVER $GENHTML $FULLINFO -o ${OUTDIR} 2> >(grep -v Devel::Cover: > ${STDERR}) >${STDOUT}
RC=$?
